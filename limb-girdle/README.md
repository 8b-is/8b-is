...
> the person is not. This folder is the deep-research foundation — three
> pillars (base · foundation · research), versioned and growing.
...
|---|---|
| [`base.md`](base.md) | what is it, and which protein broke? the 32 subtypes, the genes, the molecular anatomy |
...
| [`trials.md`](trials.md) | the live trial registry — every active LGMD trial, one row per trial, machine-readable |
